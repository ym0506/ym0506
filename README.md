...
[English](./README.en.md) · [오픈소스 기여 상세](./SHARDINGSPHERE_CONTRIBUTIONS.ko.md) · [프로젝트 검증 결과](./ROUTECONTRACT.md)
...
- **배포와 검증:** **v0.1.3 Maven Central 배포**, 릴리스 Java/MySQL 테스트 **62개 통과**. [수치·조건·근거](./ROUTECONTRACT.md)
